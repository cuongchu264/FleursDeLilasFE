        ...
        {supplies.map((supply) => (
          <article className="resource-card" key={supply.id}>
            <div className="card-header">
              ...
              <span className="resource-price">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(supply.price)}</span>
            </div>
